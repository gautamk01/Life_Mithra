...
export const heroData: HeroProps = {
  ...
  subtitle: (
    <>
      <span className="hidden md:inline">
        Want to live a better life? Learn the skills that matter with Life Mithra. Our life coaching programs can help
        you achieve your goals and dreams. Sign up for a free session today. Life Mithra: Be Your Own Best Friend.
      </span>{' '}
    </>
  ),
  callToAction: {
